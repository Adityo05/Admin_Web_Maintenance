...
<form method="GET" action="{{ route('maintenance-schedule.index') }}" style="margin-bottom: 20px;">
    <div style="display: flex; gap: 12px; align-items: center; flex-wrap: wrap;">
        ...
        @endif
        <a href="{{ route('maintenance-schedule.create') }}" class="btn btn-primary" style="width: auto; padding: 8px 20px; height: auto; text-decoration: none; display: flex; align-items: center; gap: 8px;">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
